...
Artwork.create(image: "/images/animals/oh-dear-a-deer.jpg",
...
Artwork.create(image: "/images/animals/oh-wise-seagull.jpg",
...
Artwork.create(image: "/images/animals/Pretty-as-a-Peacock.jpg",
...
Artwork.create(image: "/images/animals/Rooster-of-Crowsville.jpg",
...
Artwork.create(image: "/images/animals/smiling-birdy.jpg",
				  title: "Smiling Birdy",
				  medium: "Collage",
				  dimensions: '5"x7"',
				  category: categories.find{|c| c.name == "animals"},
...
Artwork.create(image: "/images/animals/squirrel.jpg",
				  title: "Squirrel!",
				  medium: "Collage",
				  dimensions: '5"x7"',
				  category: categories.find{|c| c.name == "animals"},
...
Artwork.create(image: "/images/animals/The-Dancing-Frog.jpg",
...
Artwork.create(image: "/images/animals/The-Woodpecker-Carpenter.jpg",
...
Artwork.create(image: "/images/animals/Trumpeting-Elephant.jpg",
...
Artwork.create(image: "/images/people/Chow-Time.jpg",
				  title: "Chow Time",
				  medium: "Collage",
				  dimensions: '18"x24"',
				  category: categories.find{|c| c.name == "people"},
...
Artwork.create(image: "/images/people/Hide-and-Seek-on-the-Subway.jpg",
...
Artwork.create(image: "/images/people/Leisure-Day.jpg",
				  title: "Leisure Day",
				  medium: "Collage",
				  dimensions: '18"x24"',
				  category: categories.find{|c| c.name == "people"},
...
Artwork.create(image: "/images/people/Looking-Like-Hollywood.jpg",
...
Artwork.create(image: "/images/people/M-Ward.jpg",
				  title: "M. Ward",
				  medium: "Collage",
				  dimensions: '5"x7"',
				  category: categories.find{|c| c.name == "people"},
...
Artwork.create(image: "/images/people/Riverside-Loungers.jpg",
...
Artwork.create(image: "/images/people/sight-seeing.jpg",
...
Artwork.create(image: "/images/people/Snorkeling.jpg",
				  title: "Snorkeling",
				  medium: "Collage",
				  dimensions: '24"x18"',
				  category: categories.find{|c| c.name == "people"},
...
Artwork.create(image: "/images/people/The-Hikers.jpg",
				  title: "The Hikers",
				  medium: "Collage",
				  dimensions: '24"x18"',
				  category: categories.find{|c| c.name == "people"},
...
Artwork.create(image: "/images/people/twosacrowd.jpg",
				  title: "Two's a Crowd",
				  medium: "Collage",
				  dimensions: '24"x18"',
				  category: categories.find{|c| c.name == "people"},
...
Artwork.create(image: "/images/places/City-Sunsets.jpg",
				  title: "City Sunsets",
				  medium: "Collage",
				  dimensions: '5"x7"',
				  category: categories.find{|c| c.name == "places"},
...
Artwork.create(image: "/images/places/Daytime-at-the-Capitol.jpg",
...
Artwork.create(image: "/images/places/DC-Reflections.jpg",
...
Artwork.create(image: "/images/places/Downtown-Shopping.jpg",
...
Artwork.create(image: "/images/places/National-Museum-of-the-American-Indian.jpg",
...
Artwork.create(image: "/images/places/Over-and-Under.jpg",
...
Artwork.create(image: "/images/places/The-Botanic-Garden.jpg",
...
Artwork.create(image: "/images/places/The-Washington-Monument-at-Sunset.jpg",
...
Artwork.create(image: "/images/places/The-Woods-by-Day.jpg",
...
Artwork.create(image: "/images/places/The-Woods.jpg",
				  title: "The Woods",
				  medium: "Collage",
				  dimensions: '16"x20"',
				  category: categories.find{|c| c.name == "places"},
...
Artwork.create(image: "/images/things/Coffee-Refuel.jpg",
				  title: "Coffee Refuel",
				  medium: "Collage",
				  dimensions: '5"x7"',
				  category: categories.find{|c| c.name == "things"},
...
Artwork.create(image: "/images/things/Cone-Flower.jpg",
				  title: "Cone Flower",
				  medium: "Collage",
				  dimensions: '9"x12"',
				  category: categories.find{|c| c.name == "things"},
...
Artwork.create(image: "/images/things/Daffodils.jpg",
				  title: "Daffodils",
				  medium: "Collage",
				  dimensions: '16"x20"',
				  category: categories.find{|c| c.name == "things"},
...
Artwork.create(image: "/images/things/Deli-Sandwich.jpg",
				  title: "Deli Sandwich",
				  medium: "Collage",
				  dimensions: '5"x7"',
				  category: categories.find{|c| c.name == "things"},
...
Artwork.create(image: "/images/things/Did-Somebody-Say-Cake.jpg",
...
Artwork.create(image: "/images/things/Gelato-Time.jpg",
				  title: "Gelato Time",
				  medium: "Collage",
				  dimensions: '5"x7"',
				  category: categories.find{|c| c.name == "things"},
...
Artwork.create(image: "/images/things/Pancakes-and-Coffee.jpg",
...
Artwork.create(image: "/images/things/Pink-Flowers.jpg",
				  title: "Pink Flowers",
				  medium: "Collage",
				  dimensions: '9"x12"',
				  category: categories.find{|c| c.name == "things"},
...
Artwork.create(image: "/images/things/purple-pansy.jpg",
				  title: "Purple Pansy",
				  medium: "Collage",
				  dimensions: '9"x12"',
				  category: categories.find{|c| c.name == "things"},
...
Artwork.create(image: "/images/things/Shrimp-and-Grits.jpg",
