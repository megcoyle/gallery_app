...
*Something to add to the application at a later date, or to work on in the future, would be the ability for users to create "wish lists" or "favorite lists" for artwork